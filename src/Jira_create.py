...
def main():
    ...
    parser.add_argument("-k", "--projectkey", action="store", type=str, help="JIRA Project Key")
    parser.add_argument("-p", "--prid", action="store", type=str, help="Pull Request ID")
    parser.add_argument("-j", "--jirausername", action="store", type=str, help="JIRA Username")
    parser.add_argument("-b", "--buildusername", action="store", type=str, help="${USER FULL NAME}")
